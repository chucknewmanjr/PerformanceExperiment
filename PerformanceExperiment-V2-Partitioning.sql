...
insert [dbo].[AppSetting] values
	...
	('PROCESS TRANSACTIONS ROW COUNT', 50e3) -- 10e3 is 10K. Rows processed in each loop.
go
...
create table [dbo].[Staging] (
	...
	primary key clustered (StagingID, UserID)
...
create or alter proc [dbo].[LogExecution] (
	@RunID smallint, 
	@UserID tinyint, 
	@RowCount int, 
	@Start datetime2(7), 
	...
	/*
		exec [dbo].[LogExecution] @RunID, @UserID, @RowCount, @Start, @ErrorMessage;
	*/
